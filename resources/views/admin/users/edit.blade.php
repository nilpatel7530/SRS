                ...
                <div class="col-md-8">
                    <div class="card card-outline card-warning shadow-sm">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-user-edit mr-2"></i>Personal Information</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="card card-outline card-success shadow-sm">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 shadow-sm @error('roles') is-invalid @enderror" name="roles[]" multiple="multiple" data-placeholder="Select roles" style="width: 100%;" required>
                                    @foreach($roles as $role)
                                        <option value="{{ $role->name }}" {{ (is_array(old('roles', $userRoles)) && in_array($role->name, old('roles', $userRoles))) ? 'selected' : '' }}>{{ $role->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="card-footer bg-white text-right">
                            ...
                            <button type="submit" class="btn btn-warning px-4">Update User Account</button>
                        </div>
                    </div>
                </div>
            </div>
